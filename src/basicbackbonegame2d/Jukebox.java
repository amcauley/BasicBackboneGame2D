...
public class Jukebox {
    ...
    public enum Sounds {
        ...
        BG_MUSIC0("resources/sounds/BG_Music0.wav"), DOOR0("resources/sounds/StringDoor.wav"),
    ...
    /*
     * Play a given sound/music, with a flag indicating if it should loop.
     */
    public void play(Sounds sound, boolean loop) {

        /*
         * Whenever we get a new play request, clean up any clips that are no longer
         * active, ex. completed single-use effects. Need to use iterators, otherwise
         * can run into concurrent modification issues.
         */
        ...
        /*
         * If we're already playing this sound, exit. May want to add extra abilities
         * later, such as a flag to restart if already playing vs just ignoring new
         * request.
         */
        for (ClipInfo c : clips) {
        ...
        try {
            ...
            AudioInputStream inputStream = AudioSystem
                    .getAudioInputStream(getClass().getClassLoader().getResource(sound.fileName));
